...
function Navegation(){
    ...
    <div className="flex justify-around gap-4 items-center px-4 py-1 bg-black rounded-[15px] ring-1 ring-white mobille"
>
  ...
  <div className="relative group hover:cursor-pointer hover:bg-slate-800 p-4 rounded-full transition-all duration-500"
  >
    <svg
      width="30"
      height="30"
